...
🛠 Project Overview
FluffyClouds allows users to upload video files (MP4, MOV, etc.), extracts the audio stream, and processes it through a neural network to provide a full, time-stamped (optional) transcription.
